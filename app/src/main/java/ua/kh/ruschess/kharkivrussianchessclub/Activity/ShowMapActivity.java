...
public class ShowMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        for(int i = 0; i < city_list.length; i += 3){
            mMap.addMarker(new MarkerOptions().position(new LatLng(Double.parseDouble(city_list[i + 1]), Double.parseDouble(city_list[i + 2]))).title(city_list[i]));
        }
    }
}
