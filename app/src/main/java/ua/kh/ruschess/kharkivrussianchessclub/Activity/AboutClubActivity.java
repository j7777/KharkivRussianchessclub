...
public class AboutClubActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView aboutText = (TextView) findViewById(R.id.text_about_club);

        try {
            InputStream inStream = getResources().openRawResource(R.raw.about_text);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent intent = new Intent(AboutClubActivity.this, SettingsActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_about) {
            Intent intent = new Intent(AboutClubActivity.this, AboutClubActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_event) {
            Intent intent = new Intent(AboutClubActivity.this, EventsActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_rules) {
            Intent intent = new Intent(AboutClubActivity.this, RulesActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_clock) {
            Intent intent = new Intent(AboutClubActivity.this, GameClockActivity.class);
            startActivity(intent);
            ...
            startActivity(new Intent(AboutClubActivity.this, ShowMapActivity.class));
        } else if (id == R.id.nav_author) {
            Intent intent = new Intent(AboutClubActivity.this, AuthorActivity.class);
            startActivity(intent);
